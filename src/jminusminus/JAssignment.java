...
class JAndAssignOp extends JAssignment {
    ...
    /**
     * Construct an AST node for a logical AND_ASSIN expression given its line number,
     * and lhs and rhs operands.
     * 
     * @param line
     *            line in which the logical AND_ASSIGN expression occurs in the source
     *            file.
     * @param lhs
     *            lhs operand.
     * @param rhs
    ...
    /**
     * Analyzing a logical AND_ASSIGN expression involves analyzing its operands and
...
class JZeroFillRightBitShiftAssignOp extends JAssignment {

    public JZeroFillRightBitShiftAssignOp(int line, JExpression lhs, JExpression rhs) {
        super(line, ">>>=", lhs, rhs);
    }
...
class JRightBitShiftAssignOp extends JAssignment {

    public JRightBitShiftAssignOp(int line, JExpression lhs, JExpression rhs) {
        super(line, ">>=", lhs, rhs);
    }
...
class JLeftBitShiftAssignOp extends JAssignment {

    public JLeftBitShiftAssignOp(int line, JExpression lhs, JExpression rhs) {
        super(line, "<<=", lhs, rhs);
    }
