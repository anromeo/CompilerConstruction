...
class JLogicalOrOp extends JBooleanBinaryExpression {
     ...
     */
    public void codegen(CLEmitter output, String targetLabel, boolean onTrue) {
    	String firstTrueLabel = output.createLabel();        	
        lhs.codegen(output, firstTrueLabel, true);            
        rhs.codegen(output, targetLabel, false);
        output.addLabel(firstTrueLabel);      
    }
}
...
class JBitXOrOp extends JBooleanBinaryExpression {
